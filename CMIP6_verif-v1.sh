...
## Calculs de classification par saison
R CMD BATCH "--args JJA ${NMOD} ${JOBID}" ${HOME}/programmes/RStat/CMIP6class/CMIP6_tensorflow-verif_v1.R
R CMD BATCH "--args DJF ${NMOD} ${JOBID}" ${HOME}/programmes/RStat/CMIP6class/CMIP6_tensorflow-verif_v1.R
R CMD BATCH "--args MAM ${NMOD} ${JOBID}" ${HOME}/programmes/RStat/CMIP6class/CMIP6_tensorflow-verif_v1.R
R CMD BATCH "--args SON ${NMOD} ${JOBID}" ${HOME}/programmes/RStat/CMIP6class/CMIP6_tensorflow-verif_v1.R

## Synthese des resultats pour les 4 saisons
